...
export default function contact() {
  return (
    <div className="my-10">
      ...
      <div className="flex sm:flex-row flex-col justify-around items-center gap-2 p-5 my-5 ">
        <div className="border-2 border-green py-5 px-10 sm:mb-0 mb-2">
        ...
        <div className="border-2 border-green py-5 px-10">
          <div className="flex gap-2 items-center">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
